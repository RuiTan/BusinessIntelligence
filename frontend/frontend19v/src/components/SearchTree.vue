...
export default {
  ...
  computed: {
    data() {
      let data = [//树形控件中的属性
        { name: "ns0_AcademicQualification", data: [] },
        { name: "ns0_AcademicDegree", data: [] },
        { name: "ns0_DirectorRole", data: [] },
        { name: "ns0_DirectorShip", data: [] },
        { name: "ns0_Major", data: [] },
        { name: "ns0_OfficeRole", data: [] },
        { name: "ns0_OfficeShip", data: [] },
        { name: "ns0_Person", data: [] },
        { name: "ns0_TenurelnOrganization", data: [] },
        { name: "ns4_AssetClass", data: [] },
        { name: "ns4_Instrument", data: [] },
        { name: "ns4_Quote", data: [] },
        { name: "ns5_Activity", data: [] },
        { name: "ns5_BusinessClassification", data: [] },
        { name: "ns5_BusinessSector", data: [] },
        { name: "ns5_EconomicSector", data: [] },
        { name: "ns5_Industry", data: [] },
        { name: "ns5_IndustryGroup", data: [] },
        { name: "ns6_Currency", data: [] },
        { name: "ns6_CurrencySubunit", data: [] },
        { name: "ns7_Organization", data: [] },
      ];
      ...
      //   console.log(node)
      //   for(let ele of data){
      //     if(node.properties.label == ele.name){
      //       ele.data.push(node)
      //     }
      //   }
      // }
